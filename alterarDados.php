...
function validaSubmitAlterarDados(){
	...
	campoForm[3] = "Telefone";
	campoForm[4] = "Celular";
	campoForm[5] = "Endereco";
	campoForm[6] = "EnderecoNumero";
	campoForm[7] = "CEP";
	campoForm[8] = "Cidade";
	campoForm[9] = "UF";
	campoForm[10] = "NomeMae";
	campoForm[11] = "NomePai";
	campoForm[12] = "CPF";
...
<table id="tblAlterarDados">
  ...
  <tr>
    ...
    <td>
        <input type="text" name="txtNomeMae" id="txtNomeMae" size="30" maxlength="100" value="<?PHP echo $registro['nomeMae']; ?>" />
        <div id="lblErroNomeMae" class="msgErro">o campo nome da mãe está em branco</div>
    </td>
  </tr>
  <tr>
    <td class="tituloTblDireita">Nome do Pai:</td>
    <td>
        <input type="text" name="txtNomePai" id="txtNomePai" size="30" maxlength="100" value="<?PHP echo $registro['nomePai']; ?>" />
        <div id="lblErroNomePai" class="msgErro">o campo nome do pai está em branco</div>
    </td>
  </tr>
  <tr>
    ...
    <td>
        <?PHP
			if($registro['responsavel'] == "mae"){
				$checkRespM = " checked='checked'";
				$checkRespP = "";
			}else if($registro['responsavel'] == "pai"){
				$checkRespM = "";
				$checkRespP = " checked='checked'";
			}
		?>
        <label><input type="radio" id="txtResponsavel" name="txtResponsavel" value="mae"<?PHP echo $checkRespM; ?> />Mãe</label>
        <label><input type="radio" id="txtResponsavel" name="txtResponsavel" value="pai"<?PHP echo $checkRespP; ?> />Pai</label>
        <div id="lblErroResponsavel" class="msgErro">o campo responsável não está selecionado</div>
    </td>
  </tr>
  <tr>
